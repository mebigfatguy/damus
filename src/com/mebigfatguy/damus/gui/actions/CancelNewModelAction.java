...
public class CancelNewModelAction extends AbstractAction {
	
	private static final long serialVersionUID = 1496603406772991675L;
	
	private PanelViewer panelViewer;
	
	public CancelNewModelAction(PanelViewer viewer) {
